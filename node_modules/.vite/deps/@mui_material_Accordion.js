...
} from "./chunk-HY57HZ55.js";
import "./chunk-FHV4WOAL.js";
import {
  AccordionContext_default
} from "./chunk-JNNXRLHU.js";
import {
  Transition_default
} from "./chunk-D6BE55DR.js";
import "./chunk-CULFG3S5.js";
import {
  useForkRef_default
} from "./chunk-HGCA6VXH.js";
import "./chunk-M6A6FMDC.js";
import {
  chainPropTypes,
  ...
  useForkRef,
  useTimeout
} from "./chunk-A6ILMYNZ.js";
import {
  createUseThemeProps
} from "./chunk-WZAF4S4A.js";
import {
...
var Accordion = React7.forwardRef(function Accordion2(inProps, ref) {
  ...
  const handleChange = React7.useCallback((event) => {
    setExpandedState(!expanded);
    if (onChange) {
      onChange(event, !expanded);
    }
  }, [expanded, onChange, setExpandedState]);
  const [summary, ...children] = React7.Children.toArray(childrenProp);
  ...
  return (0, import_jsx_runtime5.jsxs)(AccordionRoot, _extends({
    ...
    children: [(0, import_jsx_runtime4.jsx)(AccordionContext_default.Provider, {
      value: contextValue,
      children: summary
    }), (0, import_jsx_runtime4.jsx)(TransitionSlot, _extends({
      in: expanded,
      timeout: "auto"
    }, transitionProps, {
...
true ? Accordion.propTypes = {
  ...
  children: chainPropTypes(import_prop_types3.default.node.isRequired, (props) => {
    const summary = React7.Children.toArray(props.children)[0];
    if ((0, import_react_is.isFragment)(summary)) {
      return new Error("MUI: The Accordion doesn't accept a Fragment as a child. Consider providing an array instead.");
    }
    if (!React7.isValidElement(summary)) {
